...
# Generated by qmake (1.07a) (Qt 3.3.2) on: Tue Aug 10 12:54:29 2004
# Project:  genledg.pro
# Template: app
...
accountList.o: src/accountList.cpp include/accountList.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o accountList.o src/accountList.cpp

accountStack.o: src/accountStack.cpp include/database.h \
		include/accountStack.h \
		include/accountTable.h \
		include/goBackLabel.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o accountStack.o src/accountStack.cpp

accountTable.o: src/accountTable.cpp include/database.h \
		include/accountTable.h \
		include/accountEditItem.h \
		include/accountEditType.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o accountTable.o src/accountTable.cpp

balanceElement.o: src/balanceElement.cpp include/database.h \
		include/balanceElement.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o balanceElement.o src/balanceElement.cpp

balanceSheetEditor.o: src/balanceSheetEditor.cpp include/database.h \
		include/balanceSheetEditor.h \
		include/balanceElement.h \
		include/accountList.h
...
journalDescEdit.o: src/journalDescEdit.cpp include/journalDescEdit.h \
		include/journalTable.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o journalDescEdit.o src/journalDescEdit.cpp

journalStack.o: src/journalStack.cpp include/database.h \
		include/journalStack.h \
		include/journalTable.h \
		include/journalSummary.h \
		include/goBackLabel.h
...
journalSummary.o: src/journalSummary.cpp include/database.h \
		include/journalSummary.h \
		include/journalTable.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o journalSummary.o src/journalSummary.cpp

journalTable.o: src/journalTable.cpp include/database.h \
		include/journalTable.h \
		include/journalDescEdit.h \
		include/accountEditItem.h \
		include/dateEdit.h \
...
mainStack.o: src/mainStack.cpp include/database.h \
		include/mainStack.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o mainStack.o src/mainStack.cpp

moneyEditItem.o: src/moneyEditItem.cpp include/moneyEditItem.h \
		include/moneyValidator.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moneyEditItem.o src/moneyEditItem.cpp

moneyValidator.o: src/moneyValidator.cpp include/moneyValidator.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moneyValidator.o src/moneyValidator.cpp

printer.o: src/printer.cpp include/printer.h \
		include/settings.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o printer.o src/printer.cpp

reportStack.o: src/reportStack.cpp include/database.h \
		include/printer.h \
		include/reportStack.h \
		include/goBackLabel.h \
		include/balanceSheetEditor.h \
...
settings.o: src/settings.cpp include/settings.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o settings.o src/settings.cpp

tabs.o: src/tabs.cpp include/database.h \
		include/settings.h \
		include/tabs.h \
		include/mainStack.h \
		include/accountStack.h \
